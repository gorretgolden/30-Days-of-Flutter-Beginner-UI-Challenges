...
class ValidatedRegistrationPage extends StatefulWidget {
  const ValidatedRegistrationPage({super.key});

  @override
  State<ValidatedRegistrationPage> createState() =>
      _ValidatedRegistrationPageState();
}

class _ValidatedRegistrationPageState extends State<ValidatedRegistrationPage> {
